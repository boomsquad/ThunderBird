    ...
    private static int GetNumberBetween(int min, int max) 
    {
     ...
     public void paintComponent(Graphics g) 
     {
        ...
        if (contactInSeat != null) 
        {
            ...
            // MA: PreferredName is now showing instead of first and last name.
...
class ThunderBirdFrame extends JFrame implements ActionListener 
{
    ...
    public ThunderBirdFrame() 
    {
        ...
        // MA: Changed LoadContacts to LoadContactsThread which should implement a mulithreaded version.
    ...
    public void actionPerformed(ActionEvent e) 
    {
        for(ContactTile tile : tileList) 
        {
            ...
            //     of the room. 
            // MA: Not sure how to get this to work
        }
        repaint();
    }
}
